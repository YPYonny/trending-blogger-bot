...
Puis crée une méta description (max 1000 cacaractères) unique, fait en sorte que se soit toujour une phrase complète sans couper pour la méta description.
